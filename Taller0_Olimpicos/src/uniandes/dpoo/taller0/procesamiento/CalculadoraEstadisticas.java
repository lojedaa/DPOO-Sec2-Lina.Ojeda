...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Busca cual es el pais que representacion el atleta 
	 * 
	 * @param nombre del atleta que se quiere consultar
	 * @return el nombre del pais que representa el atleta
	 *         si el nombre no se encuentra retorna null
	 */
	
	public String buscarRepresentacionPais(String nombreAtleta)
