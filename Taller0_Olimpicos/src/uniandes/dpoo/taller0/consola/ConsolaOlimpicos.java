...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de representación del atleta");
	...
	private void ejecutarRepresentacionPais()
	{   
		System.out.println("\n" + "Pais de representacion del atleta" + "\n");
		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa consultar");
		String resultado = calculadora.buscarRepresentacionPais(nombre_atleta);
		...
		{
			System.out.println("El atleta representa al pais " + resultado);
		}
